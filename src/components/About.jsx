...
const About = () => {
  const [sectionRef, isVisible, hasIntersected] = useIntersectionObserver();

  return (
    <section ref={sectionRef} id="about" className={`section about ${hasIntersected ? 'section-visible' : 'section-hidden'}`}>
      <div className="container">
        <div className="section-content">
          <h2 className={`section-title ${hasIntersected ? 'fade-in visible ripple-delay-1' : 'fade-in'}`}>About Me</h2>
          <div className="about-content">
            <div className={`about-text ${hasIntersected ? 'fade-in visible ripple-delay-2' : 'fade-in'}`}>
              <p className={`${hasIntersected ? 'fade-in visible ripple-delay-3' : 'fade-in'}`}>
              ...
              <p className={`${hasIntersected ? 'fade-in visible ripple-delay-4' : 'fade-in'}`}>
